...
echo "========================================"
echo "Starting ms-users instance setup..."
echo "Time: $(date)"
echo "========================================"
...
echo "Starting ms-users container..."
docker run -d \
  --name ms-users \
...
if [ $? -ne 0 ]; then
  echo "ERROR: Failed to start ms-users container"
...
docker ps -a | grep ms-users
docker logs --tail=50 ms-users

echo "========================================"
echo "ms-users setup completed successfully!"
echo "Time: $(date)"
echo "========================================"
